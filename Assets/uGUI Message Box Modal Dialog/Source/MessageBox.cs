...
namespace Toolkit
{
    public class MessageBox : ModalBox
    {
        ...
        public static MessageBox Show(string message, Action<DialogResult> onFinished,
        ...
        /// <param name="buttons">Selects what buttons are shown on the dialog.</param>
        /// <returns>The message box game object.</returns>
        public static MessageBox Show(string message, string title = null, Action<DialogResult> onFinished = null,
            MessageBoxButtons buttons = MessageBoxButtons.OK)
        {
            var box = (Instantiate(Resources.Load<GameObject>(PrefabResourceName)) as GameObject)
        ...
        void SetUpButtons(MessageBoxButtons buttons)
        {
            ...
            switch (buttons)
            {
                ...
                case MessageBoxButtons.OKCancel:
                    ...
                    CreateButton(button, Localize("Cancel"), () =>
                    {
                ...
                case MessageBoxButtons.AbortRetryIgnore:
                    ...
                    CreateButton(button, Localize("Retry"), () =>
                    {
                        result = DialogResult.Retry;
                        Close();
                    });
                    CreateButton(button, Localize("Ignore"), () =>
                    {

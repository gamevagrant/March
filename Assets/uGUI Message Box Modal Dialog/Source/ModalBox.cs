            ...
            if (!isSetup)
            {
                ...
                if (Title != null)
                {
                    ...
                    layoutElement.minHeight =
                        Title.preferredHeight; // Set the min height to the preferred height so that the parent dialog box vertical layout can resize correctly.
                }
                ...
                if (Message != null)
                {
                    ...
                    layoutElement.minHeight =
                        Message
                            .preferredHeight; // Set the min height to the preferred height so that the parent dialog box vertical layout can resize correctly.

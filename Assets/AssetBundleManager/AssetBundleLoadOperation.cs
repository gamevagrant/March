...
namespace AssetBundles
{
    ...
    public abstract class AssetBundleLoadAllAssetOperation : AssetBundleLoadOperation
    {
        public abstract T[] GetAsset<T>() where T : UnityEngine.Object;
    }

    public class AssetBundleLoadAllAssetOperationSimulation : AssetBundleLoadAllAssetOperation
    {
        Object[] m_SimulatedObject;

        public AssetBundleLoadAllAssetOperationSimulation(Object[] simulatedObject)
        {
            m_SimulatedObject = simulatedObject;
        }
    ...
    public class AssetBundleLoadAllAssetOperationFull : AssetBundleLoadAllAssetOperation
    {
        protected string m_AssetBundleName;
        protected string m_DownloadingError;
        protected System.Type m_Type;
        ...
        public AssetBundleLoadAllAssetOperationFull(string bundleName, System.Type type)
        {
            m_AssetBundleName = bundleName;
            m_Type = type;
        }
